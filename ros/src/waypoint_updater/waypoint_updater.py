...
class WaypointUpdater(object):
    def __init__(self):
        ...
        self.VELOCITY_MAX   = 2.777 # mps Carla max of 20 km/h (updated by waypoints_cb)                
    ...
    def update_velocities(self):
        # update all velocities in the queue if red in range of 4m (site) or 60m (sim) decel for all waypoints in the queue
